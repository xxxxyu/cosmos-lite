...
def get_rope_index_qwen3_vl(
    ...
    if input_ids is not None and (image_grid_thw is not None or video_grid_thw is not None):
        ...
        for i, input_ids in enumerate(total_input_ids):
            ...
            vision_start_indices = torch.argwhere(input_ids == vision_start_token_id).squeeze(1)  # [num_vision_starts]
            ...
            llm_positions = torch.cat(llm_pos_ids_list, dim=1).reshape(3, -1)  # [3,N_token]
